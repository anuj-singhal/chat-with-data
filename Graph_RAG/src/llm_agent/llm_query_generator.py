...
class LLMQueryGenerator:
    ...
    def generate_sql(self, context: Dict[str, Any]) -> str:
        ...
        if self.provider == "openai" and self.client:
            return self._generate_openai_sql(context)
        else:
            return self._generate_heuristic_sql(context)
    
    def _generate_openai_sql(self, context: Dict[str, Any]) -> str:
    ...
    def _generate_heuristic_sql(self, context: Dict[str, Any]) -> str:
    ...
    def _add_where_conditions(self, sql: str, query_lower: str) -> str:
...
"""
    ...
    def classify_query_type(self, sql: str) -> str:
