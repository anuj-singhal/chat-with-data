...
from sql_executor_agent.sql_formatter import SQLFormatter
...
class QueryExecutor:
    ...
    async def execute_query(self, sql_query: str) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"Executing SQL via tool '{execution_tool.name}' with parameter '{param_name}': {sql_query[:100]}...")
            #sql_query = "Select * from Banks"
            exec_sql = SQLFormatter.format_for_execution(sql_query)
